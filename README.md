...
- 설치 파일: [`dist/moa-calendar-0.1.9-debug.apk`](dist/moa-calendar-0.1.9-debug.apk) (약 12MB).
...
- 네이버 일정·할 일은 연보라, Google 일정은 초록색으로 표시합니다. 기기 캘린더는 원래 색상을 유지합니다. 표시 여부 필터는 위젯에도 적용됩니다.
...
v0.1.9 검증 결과와 갤럭시 실기기 확인은 [`docs/VALIDATION-0.1.9.md`](docs/VALIDATION-0.1.9.md), 테스트 화면은 `docs/screenshots/v0.1.9/`에 있습니다. 이전 검증 기록은 각 버전의 `docs/VALIDATION-*.md`에 보존합니다. 디자인 규칙은 [`DESIGN.md`](DESIGN.md)에 있습니다.
